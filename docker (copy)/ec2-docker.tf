...
locals {
  ...
  secgr-dynamic-ports = [22,80,443,3306]
  user = "yakin"
}
...
resource "aws_instance" "tf-ec2" {
  ...
  user_data = <<-EOF
              ...
              cd /home/ec2-user && git clone https://github.com/yakin68/mysql-php-app.git
							cd /home/ec2-user/mysql-php-app && docker-compose up
	          EOF
}  
